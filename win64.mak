...
# Unittest flags
UTFLAGS=-version=CoreUnittest -version=druntime_unittest -unittest
...
unittest : $(SRCS) $(DRUNTIME)
	*$(DMD) $(UDFLAGS) $(UTFLAGS) -ofunittest.exe -main $(SRCS) $(DRUNTIME) -debuglib=$(DRUNTIME) -defaultlib=$(DRUNTIME) user32.lib
