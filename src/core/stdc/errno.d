...
{
    enum EPERM           = 0x40000001;
    enum ENOENT          = 0x40000002;
    enum ESRCH           = 0x40000003;
    enum EINTR           = 0x40000004;
    enum EIO             = 0x40000005;
    enum ENXIO           = 0x40000006;
    enum E2BIG           = 0x40000007;
    enum ENOEXEC         = 0x40000008;
    enum EBADF           = 0x40000009;
    enum ECHILD          = 0x4000000a;
    enum EDEADLK         = 0x4000000b;
    enum ENOMEM          = 0x4000000c;
    enum EACCES          = 0x4000000d;
    enum EFAULT          = 0x4000000e;
    enum ENOTBLK         = 0x4000000f;
    enum EBUSY           = 0x40000010;
    enum EEXIST          = 0x40000011;
    enum EXDEV           = 0x40000012;
    enum ENODEV          = 0x40000013;
    enum ENOTDIR         = 0x40000014;
    enum EISDIR          = 0x40000015;
    enum EINVAL          = 0x40000016;
    enum EMFILE          = 0x40000018;
    enum ENFILE          = 0x40000017;
    enum ENOTTY          = 0x40000019;
    enum ETXTBSY         = 0x4000001a;
    enum EFBIG           = 0x4000001b;
    enum ENOSPC          = 0x4000001c;
    enum ESPIPE          = 0x4000001d;
    enum EROFS           = 0x4000001e;
    enum EMLINK          = 0x4000001f;
    enum EPIPE           = 0x40000020;
    enum EDOM            = 0x40000021;
    enum ERANGE          = 0x40000022;
    enum EAGAIN          = 0x40000023;
    enum EWOULDBLOCK     = EAGAIN;
    enum EINPROGRESS     = 0x40000024;
    enum EALREADY        = 0x40000025;
    enum ENOTSOCK        = 0x40000026;
    enum EMSGSIZE        = 0x40000028;
    enum EPROTOTYPE      = 0x40000029;
    enum ENOPROTOOPT     = 0x4000002a;
    enum EPROTONOSUPPORT = 0x4000002b;
    enum ESOCKTNOSUPPORT = 0x4000002c;
    enum EOPNOTSUPP      = 0x4000002d;
    enum EPFNOSUPPORT    = 0x4000002e;
    enum EAFNOSUPPORT    = 0x4000002f;
    enum EADDRINUSE      = 0x40000030;
    enum EADDRNOTAVAIL   = 0x40000031;
    enum ENETDOWN        = 0x40000032;
    enum ENETUNREACH     = 0x40000033;
    enum ENETRESET       = 0x40000034;
    enum ECONNABORTED    = 0x40000035;
    enum ECONNRESET      = 0x40000036;
    enum ENOBUFS         = 0x40000037;
    enum EISCONN         = 0x40000038;
    enum ENOTCONN        = 0x40000039;
    enum EDESTADDRREQ    = 0x40000027;
    enum ESHUTDOWN       = 0x4000003a;
    enum ETOOMANYREFS    = 0x4000003b;
    enum ETIMEDOUT       = 0x4000003c;
    enum ECONNREFUSED    = 0x4000003d;
    enum ELOOP           = 0x4000003e;
    enum ENAMETOOLONG    = 0x4000003f;
    enum EHOSTDOWN       = 0x40000040;
    enum EHOSTUNREACH    = 0x40000041;
    enum ENOTEMPTY       = 0x40000042;
    enum EPROCLIM        = 0x40000043;
    enum EUSERS          = 0x40000044;
    enum EDQUOT          = 0x40000045;
    enum ESTALE          = 0x40000046;
    enum EREMOTE         = 0x40000047;
    enum EBADRPC         = 0x40000048;
    enum ERPCMISMATCH    = 0x40000049;
    enum EPROGUNAVAIL    = 0x4000004a;
    enum EPROGMISMATCH   = 0x4000004b;
    enum EPROCUNAVAIL    = 0x4000004c;
    enum ENOLCK          = 0x4000004d;
    enum EFTYPE          = 0x4000004f;
    enum EAUTH           = 0x40000050;
    enum ENEEDAUTH       = 0x40000051;
    enum ENOSYS          = 0x4000004e;
    enum ENOTSUP         = 0x40000076;
    enum EILSEQ          = 0x4000006a;
    enum EBACKGROUND     = 0x40000064;
    enum EDIED           = 0x40000065;
    enum EGREGIOUS       = 0x40000067;
    enum EIEIO           = 0x40000068;
    enum EGRATUITOUS     = 0x40000069;
    enum EBADMSG         = 0x4000006b;
    enum EIDRM           = 0x4000006c;
    enum EMULTIHOP       = 0x4000006d;
    enum ENODATA         = 0x4000006e;
    enum ENOLINK         = 0x4000006f;
    enum ENOMSG          = 0x40000070;
    enum ENOSR           = 0x40000071;
    enum ENOSTR          = 0x40000072;
    enum EOVERFLOW       = 0x40000073;
    enum EPROTO          = 0x40000074;
    enum ETIME           = 0x40000075;
    enum ECANCELED       = 0x40000077;
    enum EOWNERDEAD      = 0x40000078;
    enum ENOTRECOVERABLE = 0x40000079;
}
else version (Haiku)
{
