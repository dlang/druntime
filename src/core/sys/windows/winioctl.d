...
enum : DWORD {
    ...
    FSCTL_REQUEST_OPLOCK_LEVEL_1         = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 0, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_REQUEST_OPLOCK_LEVEL_2         = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 1, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_REQUEST_BATCH_OPLOCK           = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 2, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_OPLOCK_BREAK_ACKNOWLEDGE       = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 3, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_OPBATCH_ACK_CLOSE_PENDING      = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 4, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_OPLOCK_BREAK_NOTIFY            = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 5, METHOD_BUFFERED, FILE_ANY_ACCESS),
    ...
    FSCTL_SET_ZERO_DATA                  = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 50, METHOD_BUFFERED, FILE_WRITE_DATA),
    FSCTL_QUERY_ALLOCATED_RANGES         = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 51, METHOD_NEITHER, FILE_READ_DATA),
    FSCTL_SET_ENCRYPTION                 = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 53, METHOD_NEITHER, FILE_ANY_ACCESS),
    FSCTL_ENCRYPTION_FSCTL_IO            = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 54, METHOD_NEITHER, FILE_ANY_ACCESS),
    FSCTL_WRITE_RAW_ENCRYPTED            = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 55, METHOD_NEITHER, FILE_SPECIAL_ACCESS),
    FSCTL_READ_RAW_ENCRYPTED             = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 56, METHOD_NEITHER, FILE_SPECIAL_ACCESS),
    FSCTL_CREATE_USN_JOURNAL             = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 57, METHOD_NEITHER, FILE_ANY_ACCESS),
    FSCTL_READ_FILE_USN_DATA             = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 58, METHOD_NEITHER, FILE_ANY_ACCESS),
    FSCTL_WRITE_USN_CLOSE_RECORD         = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 59, METHOD_NEITHER, FILE_ANY_ACCESS),
    FSCTL_EXTEND_VOLUME                  = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 60, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_QUERY_USN_JOURNAL              = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 61, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_DELETE_USN_JOURNAL             = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 62, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_MARK_HANDLE                    = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 63, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_SIS_COPYFILE                   = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 64, METHOD_BUFFERED, FILE_ANY_ACCESS),
    FSCTL_SIS_LINK_FILES                 = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 65, METHOD_BUFFERED, FILE_READ_DATA | FILE_WRITE_DATA),
    FSCTL_HSM_MSG                        = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 66, METHOD_BUFFERED, FILE_READ_DATA | FILE_WRITE_DATA),
    FSCTL_HSM_DATA                       = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 68, METHOD_NEITHER, FILE_READ_DATA | FILE_WRITE_DATA),
    FSCTL_RECALL_FILE                    = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 69, METHOD_NEITHER, FILE_ANY_ACCESS),
    FSCTL_READ_FROM_PLEX                 = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 71, METHOD_OUT_DIRECT, FILE_READ_DATA),
    FSCTL_FILE_PREFETCH                  = CTL_CODE_T!(FILE_DEVICE_FILE_SYSTEM, 72, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
}
...
alias PFILE_ZERO_DATA_INFORMATION = FILE_ZERO_DATA_INFORMATION*;
