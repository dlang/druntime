...
module core.sys.windows.directx.d3dx9;
nothrow @nogc:
version(Windows):

public import core.sys.windows.directx.d3d9;
...
interface ID3DXSkinInfo : IUnknown
{
    ...
    DWORD GetFVF();
    HRESULT GetDeclaration(D3DVERTEXELEMENT9[MAX_FVF_DECL_SIZE] Declaration);
...
interface ID3DXBaseMesh : IUnknown
{
    ...
    HRESULT UpdateSemantics( D3DVERTEXELEMENT9[MAX_FVF_DECL_SIZE] Declaration) ;
}
