...
*/
        ...
        PVOID VirtualAlloc(in PVOID, SIZE_T, DWORD, DWORD);
        PVOID VirtualAllocEx(in HANDLE, in PVOID, SIZE_T, DWORD, DWORD);
        BOOL VirtualFree(in PVOID, DWORD, DWORD);
        BOOL VirtualFreeEx(in HANDLE, in PVOID, DWORD, DWORD);
...
// not in MinGW 4.0 - ???
        ...
        static if (_WIN32_WINNT >= 0x500) {
                ...
                PVOID MapViewOfFile(in HANDLE, in DWORD, in DWORD, in DWORD, in DWORD);
                PVOID MapViewOfFileEx(in HANDLE, in DWORD, in DWORD, in DWORD, in SIZE_T, const PVOID);
...
extern(Windows)
BOOL TzSpecificLocalTimeToSystemTime(const LPTIME_ZONE_INFORMATION, const LPSYSTEMTIME, LPSYSTEMTIME);
