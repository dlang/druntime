...
else version (OpenBSD)
{
    ...
    // https://github.com/openbsd/src/blob/master/sys/sys/unistd.h
    enum F_OK        = 0;    /* test for existence of file */
    enum X_OK        = 0x01; /* test for execute or search permission */
    enum W_OK        = 0x02; /* test for write permission */
    enum R_OK        = 0x04; /* test for read permission */

    enum F_ULOCK     = 0;   /* unlock locked section */
    enum F_LOCK      = 1;   /* lock a section for exclusive use */
    enum F_TLOCK     = 2;   /* test and lock a section for exclusive use */
    enum F_TEST      = 3;   /* test a section for locks by other procs */
    ...
    enum _SC_PAGE_SIZE = _SC_PAGESIZE;    /* 1170 compatibility */
