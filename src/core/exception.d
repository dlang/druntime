 ...
 *  $(LREF FinalizeError).
 */
extern (C) void onFinalizeError( TypeInfo info, Throwable e, string file = __FILE__, size_t line = __LINE__ ) @trusted nothrow @nogc
{
...
private T staticError(T, Args...)(auto ref Args args) @nogc
    if (is(T : Error))
{
