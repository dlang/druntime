/**
Implementation of the D programming language's equality checks

Copyright: The D Language Foundation 2019.
License:   $(LINK2 http://www.boost.org/LICENSE_1_0.txt, Boost License 1.0)
Source:    $(DRUNTIMESRC rt/_equality.d)
*/

/**
The compiler lowers equality checks (e.g. `lhs == rhs`) to `__equals(lhs, rhs)`
for dynamic arrays.
Params:
    lhs: The left operand of the `==` operator
    rhs: The right operand of the `==` operator

Returns: `true` if `lhs` equals `rhs`, `false` otherwise
*/
